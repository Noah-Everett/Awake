...
int main( int argc, char** argv )
{
    ...
    string on = "echo " + password + " | sudo -S pmset -b sleep 0 2>nul; echo " + password + " | sudo -S pmset -b disablesleep 1 2>nul";
    string off = "echo " + password + " | sudo -S pmset -b sleep 5 2>nul; echo " + password + " | sudo -S pmset -b disablesleep 0 2>nul";
    string unpluged;
    cout << "Turning sleep off with command: sudo pmset -b sleep 0; sudo pmset -b disablesleep 1" << endl;
    ...
    cout << "Program complete. Bye bye!" << endl;
